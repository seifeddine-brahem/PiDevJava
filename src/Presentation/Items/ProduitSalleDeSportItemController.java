 ...
 * @author elbrh
 */
public class ProduitSalleDeSportItemController  {
    @FXML
    private HBox Hbox;
    @FXML
    ...
    public ProduitSalleDeSportItemController() {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("ProduitSalleDeSportItem.fxml"));
...
//        }
    ...
    public void setInfo(ProduitSalleDeSport string)
    {
