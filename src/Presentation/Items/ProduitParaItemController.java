 ...
 * @author elbrh
 */
public class ProduitParaItemController  {
    @FXML
    private HBox Hbox;
    @FXML
    ...
    public ProduitParaItemController() {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("ProduitParaItem.fxml"));
    ...
    public void setInfo(ProduitParapharmacie string)
    {
