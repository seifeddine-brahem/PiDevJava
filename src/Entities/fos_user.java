...
public class fos_user {
   ...
   private String pays;
    ...
    public fos_user(String username, String email,String pass, String adresse, String date_naissance, int code_postal,
            String sexe, int num_tel, String photo_profil, String pays) {
...
//    public fos_user(int id, String username, String email, int enabled, String salt,
//            String password, Date last_login, int locked, int expired, Date expires_at,
//            String confirmation_token, Date password_requested_at, String roles, int credentials_expired,
//            Date credentials_expire_at, String adresse, String date_naissance, int code_postal, String sexe,
//            int num_tel, String photo_profil, String pays) {
//        this.id = id;
//        this.username = username;
//        this.username_canonical = username;
//        this.email = email;
