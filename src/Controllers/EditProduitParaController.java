 ...
 * @author elbrh
 */
public class EditProduitParaController {
    ...
    @FXML
    private JFXComboBox<CategorieProduitParapharmacie> categorie;
    ...
    private ProduitParapharmacie p;
    ...
    public void initialize() {
        categorie.getItems().setAll(CategorieProduitParapharmacie.values());
        if(p != null){
        ...
        categorie.getSelectionModel().select(CategorieProduitParapharmacie.valueOf(p.getCategorie()));
        }
    }    
    /**
     ...
     * @param dialogStage
     */
    public void setProduit(ProduitParapharmacie pr) {
        this.p =pr ;
